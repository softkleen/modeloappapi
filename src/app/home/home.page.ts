...
// Simulação de um Carrinho (Na aula, isso pode vir de uma seleção de produtos)
  carrinho = [
    { produto_id: 36, quantidade: 2, desconto: 5.05 },
    { produto_id: 48, quantidade: 1, desconto: 1.90 }
  ];
